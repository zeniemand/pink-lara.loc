...
<script>
    ...
    jQuery(function($) {
        ...
        var active = 0;
        //Если выбрали радиокнопку активированную, то и раскрвыается соответсвующий блок аккордиона:
        $('#accordion input[type=radio]').each(function(ind,it) {

            //Заносим индекс активной радиокнопки:
        ...
        //Активируем текущую активную вкладку:
