            ...
            @foreach($portfolios as $portfolio)
                ...
                <div class="hentry work group">
                    <div class="work-thumbnail">
                        <div class="nozoom">
                            <img src="{{asset(env('THEME'))}}/images/portfolios/{{ $portfolio->img->max }}" alt="0061" title="0061" />
                            <div class="overlay">
                                <a class="overlay_img" href="{{asset(env('THEME'))}}/images/portfolios/{{ $portfolio->img->path }}" rel="lightbox" title="{{ $portfolio->title }}"></a>
