    ...
    @foreach($articles as $article)
            ...
            <div class="sticky hentry hentry-post blog-big group">
                ...
                <div class="thumbnail">
                    ...
                    <p class="date">
                        <span class="month">{{$article->created_at->format('M') ? $article->created_at->format('M') : ''}}</span>
                        <span class="day">{{$article->created_at->format('d') ? $article->created_at->format('d') : ''}}</span>
                    </p>
                </div>
                <!-- post meta -->
